var ApiGenerator = Generator.create({
  ...
  this.template(
    'api/app-tests.js',
    this.pathFromApp('imports/api/', this.fileCase(opts.resourceName), this.fileCase(opts.resourceName) + '.app-tests.js'),
    context
  );
  this.template(
    'api/publications.js',
    this.pathFromApp('imports/api/', this.fileCase(opts.resourceName), 'publications.js'),
    context
  );
